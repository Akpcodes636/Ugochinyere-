...
export default function ServicesCard({ service }: { service: Service }) {
  return (
    <div className="w-full max-w-[393px] h-[304px] rounded-[10px] bg-[#FBF1FD] p-[18px] flex flex-col items-center justify-center">
      ...
      <h2 className="mb-[8px] font-semibold text-[16px] md:text-[18px] text-center text-[#000000]">
        {service.title}
      </h2>
